...
ref=phyloFlash/LIB.all.final.phyloFlash.dbhits.fa nodisk \
statsfile=$out/16SrRNA-statsfiles/${sample}.statsfile \
scafstats=$out/16SrRNA-scafstats-statsfiles/${sample}.scafstats \
covstats=$out/16SrRNA-cov-statsfiles/${sample}.covstat \
rpkm=$out/16SrRNA-rpkm-statsfiles/${sample}.rpkm \
